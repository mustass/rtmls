use hot_or_not_dog::model::{label::LABELS, normalizer::Normalizer, squeezenet::Model};
...
pub fn main() {
    ...
    let img_path ="/home/sm/Dropbox/DTU/rtc/rtmls/hotdog/seefood/test/hot_dog/133012.jpg";
